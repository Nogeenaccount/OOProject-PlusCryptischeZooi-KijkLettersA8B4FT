 ...
 *
 */
public class TransferGUI implements ActionListener, ListSelectionListener {
	...
	public TransferGUI(String title) {
	...
	public static void main(String[] args) {
		TransferGUI transferFrame = new TransferGUI("Transfer");
	...
	/**
	 * screen after buy is selected, asks the user to pick a team.
	 */
	public void pickTeamBuy(JFrame basicframe) {
		Object[] array3 = new Object[20];
		for (int i = 0; i < 20; i++) {
			array3[i] = "team" + i;
		}

		@SuppressWarnings({ "rawtypes", "unchecked" })
		JList list3 = new JList(array3);
		...
		listscroller3.setPreferredSize(new Dimension(400, 200));

		JLabel info = new JLabel("Pick a team!");
		JButton cc = new JButton();
		cc.setOpaque(true);
		cc.setPreferredSize(new Dimension(150, 50));
		cc.setText("advance");
		cc.setEnabled(false);
		cc.setActionCommand("cc");
		cc.addActionListener(this);
		cc.setBorder(BorderFactory.createRaisedBevelBorder());
		this.cc = cc;

		JPanel contentpanel3 = new JPanel(new FlowLayout());

		contentpanel3.add(cc, BorderLayout.WEST);
		contentpanel3.add(listscroller3, BorderLayout.CENTER);
		contentpanel3.add(info, BorderLayout.EAST);

		basicframe.setContentPane(contentpanel3);
	...
	public void BuyPlayer(JFrame basicframe) {
		 ...
		 */
		String[] options = { "Postion", "Price", "Offense", "Defence",
				"Overal stats" };
		@SuppressWarnings({ "unchecked", "rawtypes" })
		JComboBox box = new JComboBox(options);
	...
	public void valueChanged(ListSelectionEvent e) {
		if (e.getValueIsAdjusting() == false) {
			if (this.list1.getSelectedIndex() != -1) {
			...
			if (this.list3.getSelectedIndex() != -1) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if ("cc".equals(e.getActionCommand())) {
